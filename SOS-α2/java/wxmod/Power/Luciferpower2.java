...
import wxmod.Card.Special.Climax;
import wxmod.Card.Special.PINUP;
import wxmod.Card.Uncommon.Lucifer;
import wxmod.Relic.SSS;


public class Luciferpower2 extends AbstractPower
 {
  public static final String POWER_ID = "Luciferpower2";
  ...
  int x = 0;
   ...
   public Luciferpower2(AbstractCreature owner, int amt)
   {
    this.name = NAME;
    this.ID = POWER_ID;
    this.owner = owner;
   ...
   public void onAfterUseCard(final AbstractCard card, final UseCardAction action) {
	   ...
	   if ((SSS.WeaponPonit >= 4)&&(x < 2)) {
		   if(AbstractDungeon.player.hasPower("Swordmasterpower")){
			   AbstractDungeon.actionManager.addToBottom(new com.megacrit.cardcrawl.actions.common.MakeTempCardInHandAction(new PINUP(), 1));
			   AbstractDungeon.actionManager.addToBottom(new com.megacrit.cardcrawl.actions.common.MakeTempCardInHandAction(new Climax(), 1));
			   flash();
			   x++;
			   SSS.WeaponPonit -= 4;
			   this.amount = SSS.WeaponPonit;
   ...
   static {
       powerStrings = CardCrawlGame.languagePack.getPowerStrings("Luciferpower2");
       NAME = Luciferpower2.powerStrings.NAME;
       DESCRIPTIONS = Luciferpower2.powerStrings.DESCRIPTIONS;
   }
