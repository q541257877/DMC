...
public class Rebellionpower extends AbstractPower
 {
  public static final String POWER_ID = "Rebellionpower";
  private static final PowerStrings powerStrings;
  public static final String NAME;
  public static final String[] DESCRIPTIONS;
  int x = 0;
   
   public Rebellionpower(AbstractCreature owner, int amt)
   {
    this.name = NAME;
    this.ID = POWER_ID;
    this.owner = owner;
   ...
   static {
       powerStrings = CardCrawlGame.languagePack.getPowerStrings("Rebellionpower");
       NAME = Rebellionpower.powerStrings.NAME;
       DESCRIPTIONS = Rebellionpower.powerStrings.DESCRIPTIONS;
   }
