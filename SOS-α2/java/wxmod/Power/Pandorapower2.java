...
public class Pandorapower2 extends AbstractPower
 {
  public static final String POWER_ID = "Pandorapower2";
  ...
  private int number;
   ...
   public Pandorapower2(AbstractCreature owner, int amt)
   {
    this.name = NAME;
    this.ID = POWER_ID;
    this.owner = owner;
   ...
   static {
       powerStrings = CardCrawlGame.languagePack.getPowerStrings("Pandorapower2");
       NAME = Pandorapower2.powerStrings.NAME;
       DESCRIPTIONS = Pandorapower2.powerStrings.DESCRIPTIONS;
   }
